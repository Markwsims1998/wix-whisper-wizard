...
import { 
  ...
  MessageSquare, Shield, Heart, X, LogOut
} from "lucide-react";
...
const MobileDrawerSidebar = ({ 
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onClose}>
      <DrawerOverlay className="drawer-backdrop" />
      <DrawerContent className="bg-gradient-to-b from-[#2B2A33]/95 to-[#1E1D25]/95 backdrop-blur-xl border-t-0 rounded-t-xl pb-safe">
        {/* Pull indicator for iOS feel */}
        ...
        {/* Main content */}
        <ScrollArea className="px-4 mt-4 h-[60vh]">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <Link
                  key={index}
                  to={item.path}
                  className="flex flex-col items-center gap-2 p-3 spring-animation"
