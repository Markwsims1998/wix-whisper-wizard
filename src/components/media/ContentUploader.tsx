        ...
        <Tabs defaultValue={contentType} onValueChange={(value) => setContentType(value as 'photo' | 'video')}>
          ...
          <TabsContent value="photo" className="space-y-4">
            ...
            >
              ...
              <p className="text-xs text-gray-500 mb-4">{filePreview ? "or select a new file" : "PNG, JPG or WEBP up to 10MB"}</p>
          ...
          <TabsContent value="video" className="space-y-4">
            ...
            >
              ...
              <p className="text-xs text-gray-500 mb-4">{filePreview ? "or select a new file" : "MP4, MOV or WebM up to 100MB"}</p>
              <Button type="button" variant="outline" size="sm">Browse Files</Button>
              <input 
                id="video-upload" 
                type="file" 
