...
const Video = () => {
  ...
  // Extract the video ID from URL query parameters
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {loading ? (
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                  <Avatar>
                    ...
                    <AvatarFallback>{video.profiles?.username?.charAt(0) || "U"}</AvatarFallback>
                  </Avatar>
                  <div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">The video you're looking for may have been removed or doesn't exist</p>
